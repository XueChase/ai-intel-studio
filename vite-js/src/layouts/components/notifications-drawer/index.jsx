...
export function NotificationsDrawer({ data = [], sx, ...other }) {
  ...
  const TABS = [
    { value: 'all', label: t('notifications.tabs.all'), count: 22 },
    { value: 'unread', label: t('notifications.tabs.unread'), count: 12 },
    { value: 'archived', label: t('notifications.tabs.archived'), count: 10 },
  ];
