...
import { getNavItem } from 'src/sections/chat/utils/get-nav-item';

import { useMockedUser } from 'src/auth/hooks';

export function UserChatNavItem({ selected, collapse, conversation, onCloseMobile, basePath, userId }) {
  ...
  const handleClickConversation = useCallback(async () => {
    try {
      ...
      await clickConversation(conversation.id, userId);
  ...
  }, [basePath, conversation.id, mdUp, onCloseMobile, router, userId]);
